var TableAdvanced = function () {
    ...
    var initTable1 = function () {
        ...
        function fnFormatDetails(oTable, nTr) {
            ...
            sOut += '<tr><td>提货联系人:</td><td>' + aData[14] + '</td></tr>';
            sOut += '<tr><td>提货地址:</td><td>' + aData[15] + '</td></tr>';
            sOut += '<tr><td>提货联系人电话:</td><td>' + aData[16] + '</td></tr>';
            sOut += '<tr><td colspan="2">==========================收货信息==========================</td></tr>';
            sOut += '<tr><td>收货联系人:</td><td>' + aData[17] + '</td></tr>';
            sOut += '<tr><td>收货地址:</td><td>' + aData[18] + '</td></tr>';
            sOut += '<tr><td>收货联系人电话:</td><td>' + aData[19] + '</td></tr>';
            sOut += '</table>';
        ...
        //上面表格的函数
        /* Formating function for row details */
        function fnFormatDetails0(oTable0, nTr) {
            //alert(nTr);
            var aData = oTable0.fnGetData(nTr);
            var sOut = '<table>';
            sOut += '<tr><td colspan="2">==========================提货信息==========================</td></tr>';
            sOut += '<tr><td>提货联系人:</td><td>' + aData[11] + '</td></tr>';
            sOut += '<tr><td>提货地址:</td><td>' + aData[12] + '</td></tr>';
            sOut += '<tr><td>提货联系人电话:</td><td>' + aData[13] + '</td></tr>';
            sOut += '<tr><td colspan="2">==========================收货信息==========================</td></tr>';
            sOut += '<tr><td>收货联系人:</td><td>' + aData[14] + '</td></tr>';
            sOut += '<tr><td>收货地址:</td><td>' + aData[15] + '</td></tr>';
            sOut += '<tr><td>收货联系人电话:</td><td>' + aData[16] + '</td></tr>';
            sOut += '</table>';
        ...
        var oTable0 = $('#sample_0').dataTable({
            ...
            "aLengthMenu": [
                [4, 50, 100, -1],
                [4, 50, 100, "全部"] // change per page values here
            ],
            // set the initial value
            "iDisplayLength": 4,
            "sScrollX": "100%",
        ...
        $('#sample_0').on('click', ' tbody td .row-details', function () {
            ...
            if (oTable0.fnIsOpen(nTr)) {
                ...
                /* Open this row */
                $(this).addClass("row-details-open").removeClass("row-details-close");
                oTable0.fnOpen(nTr, fnFormatDetails0(oTable0, nTr), 'details');
            }
        });
