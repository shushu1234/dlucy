var TableAdvanced = function () {
    ...
    var initTable1 = function () {
        ...
        function fnFormatDetails0(oTable0, nTr) {
            ...
            var sOut = '<table>';
            sOut += '<tr><td colspan="2">==========================提货信息==========================</td></tr>';
            sOut += '<tr><td>提货联系人:</td><td>' + aData[12] + '</td></tr>';
            sOut += '<tr><td>提货地址:</td><td>' + aData[13] + '</td></tr>';
            sOut += '<tr><td>提货联系人电话:</td><td>' + aData[14] + '</td></tr>';
            sOut += '<tr><td colspan="2">==========================收货信息==========================</td></tr>';
            sOut += '<tr><td>收货联系人:</td><td>' + aData[15] + '</td></tr>';
            sOut += '<tr><td>收货地址:</td><td>' + aData[16] + '</td></tr>';
            sOut += '<tr><td>收货联系人电话:</td><td>' + aData[17] + '</td></tr>';
            sOut += '</table>';
