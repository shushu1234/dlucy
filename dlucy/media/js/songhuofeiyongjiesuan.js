...
$(document).on("click", ".btn.blue.mini", function(e){
    ...
    for(var i=0;i<2;i++){
        Ttr.find('td').eq(0).remove();
    }
    var Ttr1="<tr>";
    Ttr1+="<td> <a href=\"#\" class=\"btn red mini icn-only\">删除</a></td>";
    Ttr1+=Ttr.html();
    Ttr1+="</tr>";
    $("#tbody0").append(Ttr1);
    Ttr.remove();
...
$(document).on("click", ".btn.red.mini", function(e){
    ...
    Ttr.find('td').eq(0).remove();
    var Ttr1="<tr>";
    Ttr1+="<td><span class=\"row-details row-details-close\"></span></td>"
    Ttr1+="<td class=\"\"><a href=\"#\" class=\"btn blue mini \">提交</a></td>";
    Ttr1+=Ttr.html();
    Ttr1+="</tr>";
    $("#tbody1").prepend(Ttr1);
    Ttr.remove();
