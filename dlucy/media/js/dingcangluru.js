var TableAdvanced = function () {
    ...
    var initTable1 = function () {
        ...
        function fnFormatDetails(oTable, nTr) {
            ...
            sOut += '<tr><td>提货联系人:</td><td>' + aData[18] + '</td></tr>';
            sOut += '<tr><td>提货地址:</td><td>' + aData[19] + '</td></tr>';
            sOut += '<tr><td>提货联系人电话:</td><td>' + aData[20] + '</td></tr>';
            sOut += '<tr><td colspan="2">==========================收货信息==========================</td></tr>';
            sOut += '<tr><td>收货联系人:</td><td>' + aData[21] + '</td></tr>';
            sOut += '<tr><td>收货地址:</td><td>' + aData[22] + '</td></tr>';
            sOut += '<tr><td>收货联系人电话:</td><td>' + aData[23] + '</td></tr>';
            sOut += '</table>';
